...
export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisCustomFilter:
      ...
      createCustomFilter_title: 'Create Custom Filter',
      ...
      deleteCustomFilter_title: 'Delete Custom Filter',
      ...
      displayLabelPlaceholder: 'Display label placeholder on unlabeled cards',
      ...
      editCustomFilter_title: 'Edit Custom Filter',
      ...
      customFilters_title: 'Custom Filters',
      filterByLabels_title: 'Filter By Labels',
      filterByMembers_title: 'Filter By Members',
      noCustomFiltersYet: 'No custom filters yet.',
      selectLabelsForThisFilter: 'Select the labels a card must have.',
      ...
      gradients: 'Gradients',
      grid: 'Grid',
      hideBoardSelector: 'Hide board selector',
    ...
    action: {
      ...
      createNewCustomFilter: 'Create new custom filter',
      ...
      deleteCustomFilter: 'Delete custom filter',
      ...
      import: 'Import',
      importBoard: 'Import into board',
      importBoard_title: 'Import Into Board',
      join: 'Join',
      leave: 'Leave',
      ...
      showBoardSelector: 'Show board selector',
