...
export default {
  ...
  BOARD_IMPORT: 'BOARD_IMPORT',
  BOARD_IMPORT__SUCCESS: 'BOARD_IMPORT__SUCCESS',
  BOARD_IMPORT__FAILURE: 'BOARD_IMPORT__FAILURE',
  ...
  CUSTOM_FILTER_CREATE: 'CUSTOM_FILTER_CREATE',
  CUSTOM_FILTER_CREATE__SUCCESS: 'CUSTOM_FILTER_CREATE__SUCCESS',
  CUSTOM_FILTER_CREATE__FAILURE: 'CUSTOM_FILTER_CREATE__FAILURE',
  CUSTOM_FILTER_CREATE_HANDLE: 'CUSTOM_FILTER_CREATE_HANDLE',
  CUSTOM_FILTER_UPDATE: 'CUSTOM_FILTER_UPDATE',
  CUSTOM_FILTER_UPDATE__SUCCESS: 'CUSTOM_FILTER_UPDATE__SUCCESS',
  CUSTOM_FILTER_UPDATE__FAILURE: 'CUSTOM_FILTER_UPDATE__FAILURE',
  CUSTOM_FILTER_UPDATE_HANDLE: 'CUSTOM_FILTER_UPDATE_HANDLE',
  CUSTOM_FILTER_DELETE: 'CUSTOM_FILTER_DELETE',
  CUSTOM_FILTER_DELETE__SUCCESS: 'CUSTOM_FILTER_DELETE__SUCCESS',
  CUSTOM_FILTER_DELETE__FAILURE: 'CUSTOM_FILTER_DELETE__FAILURE',
  CUSTOM_FILTER_DELETE_HANDLE: 'CUSTOM_FILTER_DELETE_HANDLE',
  CUSTOM_FILTER_IN_BOARD_ACTIVATE: 'CUSTOM_FILTER_IN_BOARD_ACTIVATE',
  CUSTOM_FILTER_IN_BOARD_DEACTIVATE: 'CUSTOM_FILTER_IN_BOARD_DEACTIVATE',
